...
var TimePickerComponent = function (_a) {
    ...
    var _b = useState(6), hours = _b[0], setHours = _b[1];
    var _c = useState(0), minutes = _c[0], setMinutes = _c[1];
    var _d = useState('AM'), period = _d[0], setPeriod = _d[1];
    ...
    var _g = useState(0), scrollStartTop = _g[0], setScrollStartTop = _g[1];
    var _h = useState(null), dragType = _h[0], setDragType = _h[1];
    useEffect(function () {
    ...
    var renderItems = function (type) {
        var items = [];
        if (type === 'hour') {
            items.push(jsx("div", { className: styles.timeItem }, 'empty-top-1'));
            items.push(jsx("div", { className: styles.timeItem }, 'empty-top-2'));
            for (var i = 1; i <= 12; i++) {
                items.push(jsx("div", __assign({ className: "".concat(styles.timeItem, " ").concat(hours === i ? styles.selected : '') }, { children: i.toString().padStart(2, '0') }), i));
            }
            items.push(jsx("div", { className: styles.timeItem }, 'empty-bottom-1'));
            items.push(jsx("div", { className: styles.timeItem }, 'empty-bottom-2'));
        }
        else if (type === 'minute') {
            items.push(jsx("div", { className: styles.timeItem }, 'empty-top-1'));
            items.push(jsx("div", { className: styles.timeItem }, 'empty-top-2'));
            for (var i = 0; i < 60; i++) {
                items.push(jsx("div", __assign({ className: "".concat(styles.timeItem, " ").concat(minutes === i ? styles.selected : '') }, { children: i.toString().padStart(2, '0') }), i));
            }
            items.push(jsx("div", { className: styles.timeItem }, 'empty-bottom-1'));
            items.push(jsx("div", { className: styles.timeItem }, 'empty-bottom-2'));
        }
            ...
            items.push(jsx("div", { className: styles.timeItem }, 'empty-top-1'));
            items.push(jsx("div", { className: styles.timeItem }, 'empty-top-2'));
            items.push(jsx("div", __assign({ className: "".concat(styles.timeItem, " ").concat(period === 'AM' ? styles.selected : '') }, { children: "AM" }), 'AM'));
            items.push(jsx("div", __assign({ className: "".concat(styles.timeItem, " ").concat(period === 'PM' ? styles.selected : '') }, { children: "PM" }), 'PM'));
            items.push(jsx("div", { className: styles.timeItem }, 'empty-bottom-1'));
            items.push(jsx("div", { className: styles.timeItem }, 'empty-bottom-2'));
        }
        return items;
    };
    return (jsxs("div", __assign({ className: styles.timePicker }, { children: [jsx("div", __assign({ className: styles.column }, { children: jsx("div", __assign({ className: styles.timeSection, onScroll: function () { return handleScroll('period'); }, onMouseDown: function (e) { return handleMouseDown(e, 'period'); }, ref: periodRef }, { children: jsx("div", __assign({ className: styles.scrollItems }, { children: renderItems('period') })) })) })), jsx("div", __assign({ className: styles.column }, { children: jsx("div", __assign({ className: styles.timeSection, onScroll: function () { return handleScroll('minute'); }, onMouseDown: function (e) { return handleMouseDown(e, 'minute'); }, ref: minutesRef }, { children: jsx("div", __assign({ className: styles.scrollItems }, { children: renderItems('minute') })) })) })), jsx("div", __assign({ className: styles.column }, { children: jsx("div", __assign({ className: styles.timeSection, onScroll: function () { return handleScroll('hour'); }, onMouseDown: function (e) { return handleMouseDown(e, 'hour'); }, ref: hoursRef }, { children: jsx("div", __assign({ className: styles.scrollItems }, { children: renderItems('hour') })) })) }))] })));
};
